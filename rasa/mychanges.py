...
user_message = "This is a sample message to be replaced later"
...
matrix_on = True  # This will be affected by an input from the frontend, placeholder value until that is implemented
